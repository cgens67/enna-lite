...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val PAUSE_IMAGE_URL =
            "https://raw.githubusercontent.com/enna/Enna/main/fastlane/metadata/android/en-US/images/RPC/pause_icon.png"
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/enna/Enna/main/fastlane/metadata/android/en-US/images/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: "Go to Enna"
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/enna/Enna"
    ...
    suspend fun refreshActivity(song: Song, currentPlaybackTimeMillis: Long, isPaused: Boolean = false) = runCatching {
        try {
            ...
            com.enna.music.lite.utils.GlobalLog.append(
