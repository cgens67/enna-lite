...
import com.enna.music.lite.App
import com.enna.music.lite.constants.GitHubReleasesEtagKey
import com.enna.music.lite.constants.GitHubReleasesFingerprintKey
import com.enna.music.lite.constants.GitHubReleasesJsonKey
import com.enna.music.lite.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/enna/Enna/releases?per_page=$perPage") {
                headers {
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/enna/Enna/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://github.com/enna/Enna/releases/latest/download/"
