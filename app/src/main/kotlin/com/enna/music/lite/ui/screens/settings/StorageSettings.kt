...
import com.enna.music.lite.constants.MaxImageCacheSizeKey
...
import com.enna.music.lite.extensions.tryOrNull
...
import com.enna.music.lite.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.enna.music.lite.utils.ArtworkStorage.clear(context)
            }
        }
    }
