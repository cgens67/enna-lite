...
-keep class com.enna.music.lite.models.PersistQueue { *; }
-keep class com.enna.music.lite.models.PersistPlayerState { *; }
-keep class com.enna.music.lite.models.QueueData { *; }
-keep class com.enna.music.lite.models.QueueType { *; }
-keep class com.enna.music.lite.playback.queues.** { *; }
